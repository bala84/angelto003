:r ./../_define.sql
:setvar dc_number 00009
:setvar dc_description "CCAR procs added"
...
********************************************************************************
1.0    19.02.2008 VLavrentiev  CCAR procs added   
*******************************************************************************/ 
use [$(db_name)]
GO
...
CREATE FUNCTION [dbo].[utfVCAR_CAR] 
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT VIEW DEFINITION ON [dbo].[utfVCAR_CAR] TO [$(db_app_user)]
GO


print ' '
print 'Adding uspVCAR_CAR_SelectAll...'
go
...
CREATE PROCEDURE [dbo].[uspVCAR_CAR_SelectAll]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVCAR_CAR_SelectAll] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVCAR_CAR_SelectAll] TO [$(db_app_user)]
GO


print ' '
print 'Adding uspVCAR_CAR_SaveById...'
go
...
CREATE procedure [dbo].[uspVCAR_CAR_SaveById]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVCAR_CAR_SaveById] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVCAR_CAR_SaveById] TO [$(db_app_user)]
GO


print ' '
print 'Adding uspVCAR_CAR_DeleteById...'
go
...
CREATE procedure [dbo].[uspVCAR_CAR_DeleteById]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVCAR_CAR_DeleteById] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVCAR_CAR_DeleteById] TO [$(db_app_user)]
GO

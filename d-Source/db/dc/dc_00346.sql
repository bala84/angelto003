...
:setvar dc_number 00346
:setvar dc_description "repair by car table fixed"
...
********************************************************************************
1.0    06.07.2008 VLavrentiev  repair by car table fixed
*******************************************************************************/ 
use [$(db_name)]
GO
...
alter table dbo.CREP_REPAIR_BY_CAR_DAY

:r ./../_define.sql
:setvar dc_number 00105                   
:setvar dc_description "check_ts_type fixed#3"
...
********************************************************************************
1.0    13.03.2008 VLavrentiev  check_ts_type fixed#3
*******************************************************************************/ 
use [$(db_name)]
GO
...
DECLARE @p_Result_id numeric(38,0), @v_periodicity numeric(38,0)
       ...
       WHERE (case when @p_run/a.periodicity <= 1
		...
		and c.run > (floor(@p_run/a.periodicity)*a.periodicity) 

...
:setvar dc_number 00291
:setvar dc_description "output worker added"
...
********************************************************************************
1.0    07.06.2008 VLavrentiev  output worker added
*******************************************************************************/ 
use [$(db_name)]
GO
...
add employee_output_worker_id numeric(38,0)
go
...
execute sp_addextendedproperty 'MS_Description', 
   'Ид выпускающего механика',
   'user', @CurrentUser, 'table', 'CWRH_WRH_ORDER_MASTER', 'column', 'employee_output_worker_id'
go


create index i_emp_output_worker_id_wrh_order_master on dbo.CWRH_WRH_ORDER_MASTER(employee_output_worker_id)
on $(fg_idx_name)
go


alter table dbo.CWRH_WRH_ORDER_MASTER
alter column employee_recieve_id numeric(38,0)
go 

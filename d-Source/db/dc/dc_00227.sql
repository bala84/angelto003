...
:setvar dc_number 00227
:setvar dc_description "reports om demands added"
...
********************************************************************************
1.0    07.05.2008 VLavrentiev  reports om demands added
*******************************************************************************/ 
use [$(db_name)]
GO
...
create unique index u_wrh_demand_master_id_crep_demand on dbo.CREP_WRH_DEMAND(wrh_demand_master_id)
on $(fg_idx_name)
go
...
create index i_car_kind_id_crep_wrh_demand on dbo.CREP_WRH_DEMAND(car_kind_id)
on $(fg_idx_name)
go
...
CREATE FUNCTION [dbo].[utfVREP_WRH_DEMAND] 
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT VIEW DEFINITION ON [dbo].[utfVREP_WRH_DEMAND] TO [$(db_app_user)]
GO
...
CREATE PROCEDURE [dbo].[uspVREP_WRH_DEMAND_DAY_SelectAll]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVREP_WRH_DEMAND_DAY_SelectAll] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVREP_WRH_DEMAND_DAY_SelectAll] TO [$(db_app_user)]
GO

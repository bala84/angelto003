...
:setvar dc_number 00262
:setvar dc_description "save report fixed#3"
...
********************************************************************************
1.0    24.05.2008 VLavrentiev  save report fixed#3
*******************************************************************************/ 
use [$(db_name)]
GO
...
create PROCEDURE [dbo].[uspVREP_CAR_SUMMARY_SelectAll]
/******************************************************************************
**
** Author : VLavrentiev
**
 ...
 if (@p_time_interval is null)
  ...
  set  @v_value_fuel_gived_id = dbo.usfConst('CAR_FUEL_GIVED_AMOUNT')
   ...
   select
		...
		,speedometer_end_indctn
		,fuel_consumption
		,(convert(decimal(18,2), fuel_consumption)*convert(decimal(18,2), 100)
...
GRANT EXECUTE ON [dbo].[uspVREP_CAR_SUMMARY_SelectAll] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVREP_CAR_SUMMARY_SelectAll] TO [$(db_app_user)]
GO

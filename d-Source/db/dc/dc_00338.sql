...
:setvar dc_number 00338
:setvar dc_description "rep repair_time_day_after_to added"
...
********************************************************************************
1.0    04.07.2008 VLavrentiev  rep repair_time_day_after_to added
*******************************************************************************/ 
use [$(db_name)]
GO
...
CREATE PROCEDURE [dbo].[uspVREP_CAR_REPAIR_TIME_DAY_AFTER_TO_SelectAll]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVREP_CAR_REPAIR_TIME_DAY_AFTER_TO_SelectAll] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVREP_CAR_REPAIR_TIME_DAY_AFTER_TO_SelectAll] TO [$(db_app_user)]
GO

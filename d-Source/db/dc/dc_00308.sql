...
:setvar dc_number 00308
:setvar dc_description "employee select report fixed"
...
********************************************************************************
1.0    17.06.2008 VLavrentiev  employee select report fixed
*******************************************************************************/ 
use [$(db_name)]
GO
...
values(1002 , 'MTO', 'Должность МТО')
insert into fbo.CSYS_CONST (id, name, description)
values( 1006, 'EVACUATOR', 'Должность Эвакуатор')
insert into fbo.CSYS_CONST (id, name, description)
values( 1007, 'DUTIER', 'Должность Дежурный')
go

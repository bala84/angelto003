...
echo.******************************************************
"F:\Program Files\Microsoft SQL Server\90\Tools\Binn\sqlcmd" -S %SQL_SERVER_NAME%%SQL_INSTANCE_NAME% -U %SQL_DBA_USER% -P %SQL_DBA_USER_PWD% -i !DC_NAME! -o %LOG_DIR%\!DC_NAME!.log
)
) else (
...
echo.******************************************************
"F:\Program Files\Microsoft SQL Server\90\Tools\Binn\sqlcmd" -S %SQL_SERVER_NAME%%SQL_INSTANCE_NAME% -U %SQL_DBA_USER% -P %SQL_DBA_USER_PWD% -i %1 -o %LOG_DIR%\%1.log
)

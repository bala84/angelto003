...
:setvar dc_number 00354
:setvar dc_description "driver list save fixed"
...
********************************************************************************
1.0    03.08.2008 VLavrentiev  driver list save fixed
*******************************************************************************/ 
use [$(db_name)]
GO
...
alter column fact_end_duty datetime
go

alter table dbo.CDRV_DRIVER_LIST
alter column fuel_exp decimal(18,9)
go
...
ALTER PROCEDURE [dbo].[uspVREP_DRIVER_LIST_Prepare]
/******************************************************************************
**
** Author : VLavrentiev
**
...
values (70, 'LIST_OPEN', 'Открытый п/л')
go

insert into dbo.csys_const(id, name, description)
values (71, 'LIST_CLOSED', 'Закрытый п/л')
go

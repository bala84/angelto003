...
:setvar dc_number 00441
:setvar dc_description "car exit rep fix#2"
...
********************************************************************************
1.0   02.04.2009 VLavrentiev   car exit rep fix#2
*******************************************************************************/ 
use [$(db_name)]
GO
...
,case when (a.date_planned is not null
	  ...
	  then case when datediff("mi", a.date_planned, a.date_exit) > 480
				then null
				else datediff("mi", a.date_planned, a.date_exit)
			end
	  else null
  end as wait_time
 from

...
:setvar dc_number 00436
:setvar dc_description "driver plan detail fill fix"
...
********************************************************************************
1.0   29.03.2009 VLavrentiev   driver plan detail fill fix
*******************************************************************************/ 
use [$(db_name)]
GO
...
begin
  set nocount on
	...
	select  @p_curr_date = dbo.usfUtils_TimeToZero(@p_curr_date)
	   ...
	   select car_id, @p_curr_date, "time", employee_id, shift_number, comments ,mech_employee_id, 0
			,rownum, organization_id, organization_sname, car_kind_id, car_kind_sname	
...
create unique index u_wrh_wrh_income_order_detail_wrh_income_order_master_id_car_id_good_category_id  
on dbo.CWRH_WRH_INCOME_ORDER_DETAIL(wrh_income_order_master_id, car_id, good_category_id)
on $(fg_idx_name)
go

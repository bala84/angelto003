...
execute sp_addextendedproperty 'MS_Description', 
   'Ид организации',
   'user', @CurrentUser, 'table', 'CREP_CAR_HOUR', 'column', 'organization_id'
go
...
execute sp_addextendedproperty 'MS_Description', 
   ...
   'user', @CurrentUser, 'table', 'CREP_CAR_HOUR', 'column', 'organization_sname'
go
...
execute sp_addextendedproperty 'MS_Description', 
   'Ид организации',
   'user', @CurrentUser, 'table', 'CREP_CAR_DAY', 'column', 'organization_id'
go
...
execute sp_addextendedproperty 'MS_Description', 
   'Название организации',
   'user', @CurrentUser, 'table', 'CREP_CAR_DAY', 'column', 'organization_sname'
go
...
execute sp_addextendedproperty 'MS_Description', 
   'Ид организации',
   'user', @CurrentUser, 'table', 'CREP_CAR_MONTH', 'column', 'organization_id'
go
...
execute sp_addextendedproperty 'MS_Description', 
   'Название организации',
   'user', @CurrentUser, 'table', 'CREP_CAR_MONTH', 'column', 'organization_sname'
go




create index i_organization_id_crep_car_hour on dbo.CREP_CAR_HOUR (organization_id)
on $(fg_idx_name)
go

create index i_organization_id_crep_car_day on dbo.CREP_CAR_DAY (organization_id)
on $(fg_idx_name)
go

create index i_organization_id_crep_car_month on dbo.CREP_CAR_MONTH (organization_id)
on $(fg_idx_name)
go

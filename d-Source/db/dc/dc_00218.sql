...
:setvar dc_number 00218
:setvar dc_description "month plan month index added"
...
********************************************************************************
1.0    05.05.2008 VLavrentiev  month plan month index added
*******************************************************************************/ 
use [$(db_name)]
GO
...
execute sp_addextendedproperty 'MS_Description', 
   'Индекс месяца',
   'user', @CurrentUser, 'table', 'CDRV_MONTH_PLAN', 'column', 'month_index'
go
...
ALTER FUNCTION [dbo].[utfVDRV_MONTH_PLAN] 
/******************************************************************************
**
** Author : VLavrentiev
**

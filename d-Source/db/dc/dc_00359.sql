...
:setvar dc_number 00359
:setvar dc_description "driver list select added"
...
********************************************************************************
1.0    11.08.2008 VLavrentiev  driver list select added
*******************************************************************************/ 
use [$(db_name)]
GO
...
CREATE FUNCTION [dbo].[utfVDRV_DRIVER_LIST_SelectByCar_Id] 
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT VIEW DEFINITION ON [dbo].[utfVDRV_DRIVER_LIST_SelectByCar_Id] TO [$(db_app_user)]
GO
...
CREATE PROCEDURE [dbo].[uspVDRV_DRIVER_LIST_SelectByCar_Id]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVDRV_DRIVER_LIST_SelectByCar_Id] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVDRV_DRIVER_LIST_SelectByCar_Id] TO [$(db_app_user)]
GO

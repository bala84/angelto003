...
:setvar dc_number 00271
:setvar dc_description "car summary report fixed"
...
********************************************************************************
1.0    27.05.2008 VLavrentiev  car summary report fixed
*******************************************************************************/ 
use [$(db_name)]
GO
...
create index i_good_mark_crep_warehouse_item_day on dbo.CREP_WAREHOUSE_ITEM_DAY(good_mark)
on $(fg_idx_name)
go


create index ifk_warehouse_type_id_chis_warehouse_item on dbo.CHIS_WAREHOUSE_ITEM(warehouse_type_id)
on $(fg_idx_name)
go

create index ifk_good_category_id_chis_warehouse_item on dbo.CHIS_WAREHOUSE_ITEM(good_category_id)
on $(fg_idx_name)
go
...
CREATE PROCEDURE [dbo].[uspVREP_WAREHOUSE_ITEM_DAY_SelectAll]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVREP_WAREHOUSE_ITEM_DAY_SelectAll] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVREP_WAREHOUSE_ITEM_DAY_SelectAll] TO [$(db_app_user)]
GO

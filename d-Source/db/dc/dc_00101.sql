:r ./../_define.sql
:setvar dc_number 00101                   
:setvar dc_description "condition check type fixed#5"
...
********************************************************************************
1.0    07.03.2008 VLavrentiev  condition check type fixed#5
*******************************************************************************/ 
use [$(db_name)]
GO
...
if exists (
	...
	and d.last_ts_type_master_id is not null
	and d.last_ts_type_master_id = @p_result_id

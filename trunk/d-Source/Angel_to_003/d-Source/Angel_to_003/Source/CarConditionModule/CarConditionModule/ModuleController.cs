...
namespace Angel_to_003.CarConditionModule
{
    public class ModuleController : WorkItemController
    {
        ...
        /// <summary>
        /// Выведем представление, если нажат соответствующий узел
        /// </summary>
        ...
        public void OnNodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs eventArgs)
        {
            ...
            if (eventArgs.Node.Name == "CarCondition")
            {
                tspinfo = new TabSmartPartInfo();
                tspinfo.Title = eventArgs.Node.Text;
                
                CarConditionView ccview = ShowViewInWorkspace<CarConditionView>(Angel_to_003.Infrastructure.Interface.Constants.WorkspaceNames.RightWorkspace);

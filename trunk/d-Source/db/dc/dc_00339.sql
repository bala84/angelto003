...
values(1002, 'MECH_WORKER', 'Должность - механик')
go
...
CREATE PROCEDURE [dbo].[uspVREP_EMPLOYEE_HOUR_AMOUNT_MECH_SelectAll]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVREP_EMPLOYEE_HOUR_AMOUNT_MECH_SelectAll] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVREP_EMPLOYEE_HOUR_AMOUNT_MECH_SelectAll] TO [$(db_app_user)]
GO

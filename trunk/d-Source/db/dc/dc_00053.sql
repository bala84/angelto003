:r ./../_define.sql
:setvar dc_number 00053
:setvar dc_description "utfVDRV_DRIVER_LIST select fixed"
...
********************************************************************************
1.0    26.02.2008 VLavrentiev  utfVDRV_DRIVER_LIST select fixed   
*******************************************************************************/ 
use [$(db_name)]
GO
...
drop procedure dbo.uspVDRV_DRIVER_LIST_SelectAll
go
...
CREATE PROCEDURE [dbo].[uspVDRV_DRIVER_LIST_SelectCar]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVDRV_DRIVER_LIST_SelectCar] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVDRV_DRIVER_LIST_SelectCar] TO [$(db_app_user)]
GO
...
CREATE PROCEDURE [dbo].[uspVDRV_DRIVER_LIST_SelectFreight]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVDRV_DRIVER_LIST_SelectFreight] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVDRV_DRIVER_LIST_SelectFreight] TO [$(db_app_user)]
GO

...
:setvar dc_number 00117                  
:setvar dc_description "full text select on cars added"
...
********************************************************************************
1.0    17.03.2008 VLavrentiev  full text select on cars added
*******************************************************************************/ 
use [$(db_name)]
GO
...
drop function dbo.sfSrchCndtn_Translate
go
...
CREATE FUNCTION [dbo].[usfSrchCndtn_Translate]
/******************************************************************************
**
** Author : VLavrentiev
**
...
BEGIN
	...
	DECLARE @v_Rtrn_Stmt varchar(2000)
...
GRANT VIEW DEFINITION ON [dbo].[usfSrchCndtn_Translate] TO [$(db_app_user)]
GO

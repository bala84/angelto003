...
********************************************************************************
1.0    24.03.2008 VLavrentiev  decimal fixed
*******************************************************************************/ 
use [$(db_name)]
GO
...
alter column run decimal(18,9) not null
go

alter table dbo.CCAR_CONDITION
alter column speedometer_start_indctn decimal(18,9) not null
go

alter table dbo.CCAR_CONDITION
alter column speedometer_end_indctn decimal(18,9) not null
go


alter table dbo.CCAR_CONDITION
alter column last_run decimal(18,9) not null
go


alter table dbo.CCAR_CONDITION
alter column fuel_start_left decimal(18,9) not null
go
...
alter table dbo.CCAR_CONDITION
alter column fuel_end_left decimal(18,9) not null
go


alter table dbo.CCAR_CONDITION
alter column overrun decimal(18,9) null
go


alter table dbo.CCAR_FUEL_MODEL
alter column fuel_norm decimal(18,9) not null
go


alter table dbo.CDRV_DRIVER_LIST
alter column fuel_exp decimal(18,9) not null
go


alter table dbo.CDRV_DRIVER_LIST
alter column speedometer_start_indctn decimal(18,9)
go


alter table dbo.CDRV_DRIVER_LIST
alter column speedometer_end_indctn decimal(18,9)
go


alter table dbo.CDRV_DRIVER_LIST
alter column fuel_start_left decimal(18,9)
go

alter table dbo.CDRV_DRIVER_LIST
alter column fuel_end_left decimal(18,9)
go

alter table dbo.CDRV_DRIVER_LIST
alter column fuel_gived decimal(18,9)
go


alter table dbo.CDRV_DRIVER_LIST
alter column fuel_return decimal(18,9)
go


alter table dbo.CDRV_DRIVER_LIST
alter column fuel_addtnl_exp decimal(18,9)
go


alter table dbo.CDRV_DRIVER_LIST
alter column run decimal(18,9)
go

alter table dbo.CDRV_DRIVER_LIST
alter column fuel_consumption decimal(18,9)
go
...
drop index dbo.chis_condition.i_fuel_start_left_chis_condition
go


drop index dbo.chis_condition.i_fuel_end_left_chis_condition
go
...
alter table dbo.CHIS_CONDITION
alter column overrun decimal(18,9)
go

...
:setvar dc_number 00289
:setvar dc_description "car reports organization filter fixed"
...
********************************************************************************
1.0    06.06.2008 VLavrentiev  car reports organization filter fixed
*******************************************************************************/ 
use [$(db_name)]
GO
...
BEGIN
 ...
 if (@p_value <= @v_day_limit)
   set @v_value = convert(datetime, (SELECT convert(nvarchar(4), datepart(yyyy, @p_date_with_time)) +

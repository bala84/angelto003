...
:setvar dc_number 00329
:setvar dc_description "warehouse item day report fixed"
...
********************************************************************************
1.0    01.07.2008 VLavrentiev  warehouse item day report fixed
*******************************************************************************/ 
use [$(db_name)]
GO
...
alter table dbo.CREP_WAREHOUSE_ITEM_DAY add
organization_id numeric(38,0)
go

alter table dbo.CREP_WAREHOUSE_ITEM_DAY add
organization_sname varchar(30)
go

create index i_organization_id_rep_wrh_item_day on dbo.CREP_WAREHOUSE_ITEM_DAY(organization_id) 
on $(fg_idx_name)
go
...
execute sp_addextendedproperty 'MS_Description', 
   'Ид организации',
   'user', @CurrentUser, 'table', 'CREP_WAREHOUSE_ITEM_DAY', 'column', 'organization_id'
go
...
execute sp_addextendedproperty 'MS_Description', 
   ...
   'user', @CurrentUser, 'table', 'CREP_WAREHOUSE_ITEM_DAY', 'column', 'organization_sname'
go
...
ALTER PROCEDURE [dbo].[uspVREP_WAREHOUSE_ITEM_Prepare]
/******************************************************************************
**
** Author : VLavrentiev
**
...
ALTER PROCEDURE [dbo].[uspVREP_WAREHOUSE_ITEM_INCOME_Prepare]
/******************************************************************************
**
** Author : VLavrentiev
**
...
ALTER PROCEDURE [dbo].[uspVREP_WAREHOUSE_ITEM_OUTCOME_Prepare]
/******************************************************************************
**
** Author : VLavrentiev
**

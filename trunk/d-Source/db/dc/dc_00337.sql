...
:setvar dc_number 00337
:setvar dc_description "rep repair_time_day added"
...
********************************************************************************
1.0    04.07.2008 VLavrentiev  rep repair_time_day added
*******************************************************************************/ 
use [$(db_name)]
GO
...
CREATE FUNCTION [dbo].[utfVREP_CAR_REPAIR_TIME_DAY] 
/******************************************************************************
**
** Author : VLavrentiev
**
**-----------------------------------------------------------------------------
** Description:
** Функция отображения таблицы отчета по автомобилям
**
**
**
**------------------------------------------------------------------------------
...
(
	SELECT month_created
		 ...
		 , organization_id
		 , organization_sname
      FROM dbo.CREP_CAR_REPAIR_TIME_DAY
	
)
go

GRANT VIEW DEFINITION ON [dbo].[utfVREP_CAR_REPAIR_TIME_DAY] TO [$(db_app_user)]
GO
...
CREATE PROCEDURE [dbo].[uspVREP_CAR_REPAIR_TIME_DAY_SelectAll]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVREP_CAR_REPAIR_TIME_DAY_SelectAll] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVREP_CAR_REPAIR_TIME_DAY_SelectAll] TO [$(db_app_user)]
GO
...
select
	...
	FROM dbo.utfVREP_CAR_REPAIR_TIME_DAY() as a
	where month_created >= dbo.usfUtils_DayTo01(@p_start_date)
	  and month_created <= dbo.usfUtils_DayTo01(@p_end_date)
	  and value_id = @v_value_repair_time_id or value_id = @v_value_run_time_id
	  and (car_mark_id = @p_car_mark_id or @p_car_mark_id is null)
	  and (car_kind_id = @p_car_kind_id or @p_car_kind_id is null) 
	  and (car_id = @p_car_id or @p_car_id is null) 

:r ./../_define.sql
:setvar dc_number 00060
:setvar dc_description "VDRV_DRIVER_LIST number fixed"
...
********************************************************************************
1.0    28.02.2008 VLavrentiev  VDRV_DRIVER_LIST number fixed   
*******************************************************************************/ 
use [$(db_name)]
GO
...
create table CSYS_DRIVER_LIST_NUMBER_SEQ (
   number  numeric(38,0) identity(1,1),
   sys_comment varchar(10),
   constraint csys_driver_list_number_pk primary key (number)
         on $(db_name)_IDX
)
on "$(db_name)_DAT"
go

...
values(50, 'KIND_EVACUATOR', 'Ид вида автомобиля эвакуатор')
go

insert into dbo.csys_const(id, name, description)
values(51, 'KIND_MTO', 'Ид вида автомобиля техничка')
go

insert into dbo.csys_const(id, name, description)
values(52, 'KIND_DUTIER', 'Ид вида автомобиля дежурный')
go

insert into dbo.csys_const(id, name, description)
values(53, 'KIND_VIP', 'Ид вида автомобиля VIP - трансфер')
go

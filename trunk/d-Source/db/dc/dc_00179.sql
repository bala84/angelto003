...
:setvar dc_number 00179                  
:setvar dc_description "repair order added"
...
********************************************************************************
1.0    11.04.2008 VLavrentiev  repair order added
*******************************************************************************/ 
use [$(db_name)]
GO
...
create FUNCTION [dbo].[utfVWRH_WRH_ORDER_MASTER] 
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT VIEW DEFINITION ON [dbo].[utfVWRH_WRH_ORDER_MASTER] TO [$(db_app_user)]
GO
...
CREATE PROCEDURE [dbo].[uspVWRH_WRH_ORDER_MASTER_SelectAll]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVWRH_WRH_ORDER_MASTER_SelectAll] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVWRH_WRH_ORDER_MASTER_SelectAll] TO [$(db_app_user)]
GO
...
create procedure [dbo].[uspVWRH_WRH_ORDER_MASTER_SaveById]
/******************************************************************************
**
** Author : VLavrentiev
**
  ...
  if (@p_id is null)
    begin
	   ...
	   values
			...
			, @p_employee_worker_id, @p_order_state, @p_repair_type_id, @p_malfunction_desc
...
GRANT EXECUTE ON [dbo].[uspVWRH_WRH_ORDER_MASTER_SaveById] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVWRH_WRH_ORDER_MASTER_SaveById] TO [$(db_app_user)]
GO
...
create procedure [dbo].[uspVWRH_WRH_ORDER_MASTER_DeleteById]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVWRH_WRH_ORDER_MASTER_DeleteById] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVWRH_WRH_ORDER_MASTER_DeleteById] TO [$(db_app_user)]
GO

:r ./../_define.sql
:setvar dc_number 00061
:setvar dc_description "VDRV_DRIVER_LIST save fixed"
...
********************************************************************************
1.0    28.02.2008 VLavrentiev  VDRV_DRIVER_LIST save fixed   
*******************************************************************************/ 
use [$(db_name)]
GO
...
set identity_insert dbo.CDRV_DRIVER_LIST_STATE on
insert into dbo.CDRV_DRIVER_LIST_STATE (id, short_name, full_name)
values(70, 'Открыт', 'Открыт')
insert into dbo.CDRV_DRIVER_LIST_STATE (id, short_name, full_name)
values(71, 'Закрыт', 'Закрыт')
set identity_insert dbo.CDRV_DRIVER_LIST_STATE off
go

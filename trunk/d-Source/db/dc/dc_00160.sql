...
:setvar dc_number 00160                  
:setvar dc_description "rep_car fixed#2"
...
********************************************************************************
1.0    03.04.2008 VLavrentiev  rep_car fixed#2
*******************************************************************************/ 
use [$(db_name)]
GO
...
create procedure [dbo].[uspVREP_CAR_MONTH_SaveById]
/******************************************************************************
**
** Author : VLavrentiev
**
...
begin
	...
	set @p_sys_comment = '-'
	 if (@p_year_created is null)
	  set @p_year_created = dbo.usfUtils_MonthTo01(getdate())
	 else
	  set @p_year_created = dbo.usfUtils_MonthTo01(@p_month_created)
...
GRANT EXECUTE ON [dbo].[uspVREP_CAR_MONTH_SaveById] TO [$(db_app_user)]
GO


GRANT VIEW DEFINITION ON [dbo].[uspVREP_CAR_MONTH_SaveById] TO [$(db_app_user)]
GO
...
create FUNCTION [dbo].[usfUtils_MonthTo01](@date_with_time datetime)
RETURNS datetime
AS
BEGIN
...
GRANT VIEW DEFINITION ON [dbo].[usfUtils_MonthTo01] TO [$(db_app_user)]
GO

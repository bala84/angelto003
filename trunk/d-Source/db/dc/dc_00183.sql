...
:setvar dc_number 00183                  
:setvar dc_description "repair demand detail added"
...
********************************************************************************
1.0    12.04.2008 VLavrentiev  repair demand detail added
*******************************************************************************/ 
use [$(db_name)]
GO
...
create FUNCTION [dbo].[utfVWRH_WRH_DEMAND_DETAIL] 
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT VIEW DEFINITION ON [dbo].[utfVWRH_WRH_DEMAND_DETAIL] TO [$(db_app_user)]
GO
...
create PROCEDURE [dbo].[uspVWRH_WRH_DEMAND_DETAIL_SelectByMaster_Id]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVWRH_WRH_DEMAND_DETAIL_SelectByMaster_Id] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVWRH_WRH_DEMAND_DETAIL_SelectByMaster_Id] TO [$(db_app_user)]
GO
...
create procedure [dbo].[uspVWRH_WRH_DEMAND_DETAIL_SaveById]
/******************************************************************************
**
** Author : VLavrentiev
**
...
create procedure [dbo].[uspVWRH_WRH_DEMAND_DETAIL_DeleteById]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVWRH_WRH_DEMAND_DETAIL_DeleteById] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVWRH_WRH_DEMAND_DETAIL_DeleteById] TO [$(db_app_user)]
GO

:r ./../_define.sql
:setvar dc_number 00047
:setvar dc_description "CAR save proc fixed"
...
********************************************************************************
1.0    25.02.2008 VLavrentiev  CAR save proc fixed   
*******************************************************************************/ 
use [$(db_name)]
GO
...
alter column car_state_id numeric(38,0) null
go
...
ALTER procedure [dbo].[uspVPRT_EMPLOYEE_TYPE_SaveById]
/******************************************************************************
**
** Author : VLavrentiev
**

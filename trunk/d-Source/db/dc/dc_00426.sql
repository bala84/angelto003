...
:setvar dc_number 00426
:setvar dc_description "driver plan detail org added"
...
********************************************************************************
1.0   26.03.2009 VLavrentiev   driver plan detail org added
*******************************************************************************/ 
use [$(db_name)]
GO
...
insert into dbo.csys_const(id, name, description, subsystem, datatype)
values(18, 'Начало ночной смены', 'Данная настройка указывает на начало ночной смены', 'general', 'int')
go

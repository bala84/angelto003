...
:setvar dc_number 00226
:setvar dc_description "rep warehouse demand calculated"
...
********************************************************************************
1.0    07.05.2008 VLavrentiev  rep warehouse demand calculated
*******************************************************************************/ 
use [$(db_name)]
GO
...
CREATE procedure [dbo].[uspVREP_WRH_DEMAND_SaveById]
/******************************************************************************
**
** Author : VLavrentiev
**
...
begin
  set nocount on
    ...
    insert into dbo.CREP_WRH_DEMAND
            (wrh_demand_master_id, good_category_id, good_category_sname
			,amount, warehouse_type_id, warehouse_type_sname, car_id
			,state_number, car_type_id, car_mark_id, car_model_id
	...
	select   @p_wrh_demand_master_id, @p_good_category_id, @p_good_category_sname
			,@p_amount, @p_warehouse_type_id, @p_warehouse_type_sname, @p_car_id
			,@p_state_number, @p_car_type_id, @p_car_mark_id, @p_car_model_id
...
GRANT EXECUTE ON [dbo].[uspVREP_WRH_DEMAND_SaveById] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVREP_WRH_DEMAND_SaveById] TO [$(db_app_user)]
GO
...
CREATE PROCEDURE [dbo].[uspVREP_WRH_DEMAND_Calculate]
/******************************************************************************
**
** Author : VLavrentiev
**
...
GRANT EXECUTE ON [dbo].[uspVREP_WRH_DEMAND_Calculate] TO [$(db_app_user)]
GO

GRANT VIEW DEFINITION ON [dbo].[uspVREP_WRH_DEMAND_Calculate] TO [$(db_app_user)]
GO

...
:setvar dc_number 00479
:setvar dc_description "report_type kind fix"
...
********************************************************************************
1.0   14.07.2009 VLavrentiev   report_type kind fix
*******************************************************************************/ 
use [$(db_name)]
GO
...
select a.car_kind_id
	...
	,c.account_kind as account_gd_kind
	,convert(decimal(18,2),c.kol_gd_detail) as kol_gd_detail
	,convert(decimal(18,2),c.total_gd_detail) as total_gd_detail
	,b.good_category_id
